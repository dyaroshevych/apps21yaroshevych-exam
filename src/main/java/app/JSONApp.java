...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        ...
        JsonObject jsonObject = new JsonObject(
                        ...
                        new JsonPair("exams", new JsonArray(examsData))
        );
